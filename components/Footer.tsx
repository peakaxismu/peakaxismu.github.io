      ...
      <div className="wrap">
        <div className="footer-content">
          ...
          <div className="social-links" aria-label="Social Media Links">
            <a href="https://instagram.com/[your_instagram_handle]" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-icon-btn" title="Instagram: @[your_instagram_handle]">
            ...
            <a href="https://facebook.com/[your_facebook_url]" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-icon-btn" title="Facebook">
            ...
            <a href="https://wa.me/[your_whatsapp_number]" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-icon-btn" title="WhatsApp: [your_whatsapp_number]">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="social-svg"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
            </a>
          </div>
        </div>
