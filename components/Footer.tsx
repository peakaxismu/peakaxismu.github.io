      ...
      <div className="wrap">
        <div className="footer-content">
          ...
          <div className="social-links" aria-label="Social Media Links">
            ...
            <a href="https://www.facebook.com/peak.axis" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-icon-btn" title="Facebook">
            ...
            <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-icon-btn" title="WhatsApp">
